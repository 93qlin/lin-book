...
![img](../img/938664-20170522223732179-2029881767.png)
![img](../img/938664-20170522224049413-1823976084.gif)
...
#### 2. 实现简单版vue的过程，主要\{\{\}\}、v-model和事件指令的功能
...
结果：
 ...
 ![img](../img/938664-20170522225032257-1498304708.png)
...
![img](../img/938664-20170522225458132-1434604303.png)
...
function nodeToFragment (el) {
    ...
    while (child) {
        // 将Dom元素移入fragment中
        // appendChild这个方法是将dom节点进行移动，而不是copy
